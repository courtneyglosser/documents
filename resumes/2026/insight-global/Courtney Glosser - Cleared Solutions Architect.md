...
# Courtney Glosser - Solutions Architect

## Key Qualifications

- Over 20 years' experience developing software
- Over 10 years' of project and personnel management
- Responsible for engaging multiple stakeholders and deconflicting priorities, presenting technical documentation to leadership in a clear and concise format
- Long experience coding against REST and SOAP APIs, as well as multiple SDKs and frameworks
- Proficient with Python, JavaScript (Node.js, Angular), Java, PHP, and onboarding to new languages
- Proven experience with web application technology, deployment, and maintenance
- Experienced with architecting, optimizing, and creating and using ORMs for Databases (both relational and no-SQL)
- Certified Scrum Master with 15 years' experience working in agile methodology
