...
# Courtney Glosser - Staff Backend Engineer

## Key Qualifications

- Over 20 years' experience developing software
- Strong experience with Python, JavaScript (Node.js, Angular), Java, PHP, and onboarding to new languages
- Experience driving through all aspects of the SDLC from requirements gathering through O&M
- Strong track record of operating in multiple environments:  AWS Serverless, event-driven; On-premises, hybrid, and cloud-centric data lake; and large-scale ETL processing
...
- Experienced with architecting, optimizing, and creating Databases (both relational and no-SQL)
...
- Over 10 years' experience in DoD and IC environments delivering to USGC users
...
- Drove the shift from monolithic systems to microservice architecture, leveraging cloud, automatically provisioned VMs, and containerized CI/CD deployments.
...
- Project Manager overseeing largest client accounts for the Cloud services offering
...
- Served in various leadership roles in local business development groups
