...
# Courtney Glosser - Software Architect
...
- Experience with large-scale ETL technology (NiFi, Kafka, Spark)
- Experience with ETL monitoring and visualization tools (Prometheus, Grafana, ELK-stack and Splunk)
- Fluent in containerized technology including Kubernetes hosted solutions on secure cloud platform
- Lead multiple projects of varying sizes from initial stakeholder sale to enterprise production deployment
- Comfortable with DevOps tooling (Jenkins, Github / Gitlab, Helm Charts, etc.)
- AWS and Azure cloud experience and certification
...
- Provided guidance and mentorship to team developers and team managers
